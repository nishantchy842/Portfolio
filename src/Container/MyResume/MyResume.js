...
const MyResume = () => {
  const education = [
    ...
    { board: '+2 Science Stream', school: 'Prasadi Academy', address: 'Minbhawan, Lalitpur', year: '2016-2028' },
      ...
      <div className='mero-resume1'>
        ...
        <div className='mero-resume'>
          <div className='education' >
            <h3 style={{ textAlign: 'center', marginBottom: '50px' }}><FaUserGraduate style={{color:'#fff'}}/> Educational Qualification</h3>
            {
              education.map(item => {
                return (
